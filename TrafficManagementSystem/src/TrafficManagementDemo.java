public class TrafficManagementDemo {
    ...
    public static void run() {
        ...
        // Handle emergency on a specific road
        trafficController.handleEmergency("R1");

        // Check emergency status
        boolean isEmergency = trafficController.isAnEmergencyState("R1");

        // Cancel emergency if needed
        trafficController.cancelEmergency("R1");
    }
